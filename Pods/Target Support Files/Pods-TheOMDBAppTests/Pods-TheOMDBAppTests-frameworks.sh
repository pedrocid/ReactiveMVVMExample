...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_framework 'Pods-TheOMDBAppTests/Alamofire.framework'
  install_framework 'Pods-TheOMDBAppTests/Decodable.framework'
  install_framework 'Pods-TheOMDBAppTests/ReactiveCocoa.framework'
